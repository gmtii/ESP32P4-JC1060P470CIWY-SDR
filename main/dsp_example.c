...
void generate_FIRD_coefficients(float *fir_coeffs, const unsigned int fir_len, const float ft)
{
...
void dsp_example()
{
    ...
    generate_FIRD_coefficients(fir_coeffs, fir_len, fir_ft);
    ESP_LOGI(TAG, "\n");
