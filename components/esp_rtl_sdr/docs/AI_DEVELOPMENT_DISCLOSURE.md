...
| Re-soaked from *this* tree on hardware | **Partial** — 0.8.0-rc3 V3c cold/transition and V4 FM/HF routes were exercised through OrcSDR; true LF and Nooelec remain open; tracked in [PROJECT_TRUTH.md](../PROJECT_TRUTH.md) |
